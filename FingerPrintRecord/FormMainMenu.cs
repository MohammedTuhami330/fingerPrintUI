...
/*namespace BioBridgeSDKDLL
{
    ...
    public delegate void IBioBridgeSDKEvents_OnConnectedEventHandler();
}*/
    ...
    public partial class FormMainMenu : Form
    {
        ...
        */
        ...
        private void ActivateButton(object btnSender)
        {
            if (btnSender != null)
            {
                if(cuurentButton!= (Button)btnSender)
                {
                    DisableButton();
                    Color color = SelectThemeColor();
                    cuurentButton = (Button)btnSender;
                    cuurentButton.BackColor = color;
                    cuurentButton.ForeColor = Color.White;
                    cuurentButton.Font = new System.Drawing.Font("Tahoma", 12.5F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
        ...
        private void DisableButton()
        {
            foreach(Control prevBtn in panelMenu.Controls)
            {
                if(prevBtn.GetType() == typeof(Button))
                {
                    ...
                    prevBtn.Font = new System.Drawing.Font("Tahoma", 10F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
                }
            }
        }
        ...
        private void OpenChildForm(Form childForm , object btnSender)
        {
            ...
            this.pnlDsktp.Controls.Add(childForm);
            this.pnlDsktp.Tag = childForm;
        ...
        {
            OpenChildForm(new Forms.FormEditUsr(), sender);
        }
